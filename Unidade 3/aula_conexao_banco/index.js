...
app.get('/', async (req, res) => {
    ...
    try {
        ...
        // const query = 'select e.id as empresaId, f.id as filiaisId, e.nome, f.pais from empresas e full join filiais f on e.id = f.empresa_id;'

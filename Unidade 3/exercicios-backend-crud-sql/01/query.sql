...
-- 4
delete from usuarios where senha = 's5F51T7L';

-- 5
insert into usuarios (nome, idade, email, senha) values ('Jermaine G. Sellers', 16, 'ligula.Nullam@tortordictum.co.uk', 'o2P56U9U'),
